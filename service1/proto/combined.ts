...
export const OboardingFlags = {
  ...
  create<I extends Exact<DeepPartial<OboardingFlags>, I>>(base?: I): OboardingFlags {
    return OboardingFlags.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<OboardingFlags>, I>>(object: I): OboardingFlags {
    const message = createBaseOboardingFlags();
