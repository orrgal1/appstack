...
export class DummyService {
  ...
  async createOne(data: DummyCreateOneInput): Promise<Dummy> {
    return postToUnary<Dummy>(this.serviceName, 'createOne', data);
  }

  async updateOne(data: DummyUpdateOneInput): Promise<Dummy> {
    return postToUnary<Dummy>(this.serviceName, 'updateOne', data);
  }

  async findOne(data: DummyFindOneInput): Promise<Dummy> {
    return postToUnary<Dummy>(this.serviceName, 'findOne', data);
  }

  async removeOne(data: DummyRemoveOneInput): Promise<Empty> {
    return postToUnary<Empty>(this.serviceName, 'removeOne', data);
  }

  async search(data: DummySearchInput): Promise<DummySearchResult> {
